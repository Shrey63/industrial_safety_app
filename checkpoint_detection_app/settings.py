"""
Django settings for checkpoint_detection_app project.
...
SECRET_KEY = 'django-insecure-u8^1z72k$-jl_#=mjuttvt^!v3c&ilw40+h$w*i63u#6hnjhxz'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "templates"],  # Adjust the path if needed
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
