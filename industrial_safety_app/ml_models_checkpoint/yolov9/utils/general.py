...
def check_suffix(file='yolo.pt', suffix=('.pt',), msg=''):
    ...
    print(f"Sanitized weights path: {file!r}")

    print(f"Raw file string: {file!r}")  # Show raw representation of the file string
    print(f"Checking suffix for: {file}")
    print(f"Acceptable suffixes are: {suffix}")
    assert any(file.endswith(s) for s in suffix), f"{msg}{file} acceptable suffix is {suffix}"
